...
function ProjectSlide({ project, visible }) {
  ...
  return (
    <div ref={ref} className={styles.slide} style={{ '--accent': project.accent }}>
      {/* 3D scene placeholder — Phase 7.2/7.3/7.4 will replace with real scenes */}
      <div className={styles.scenePlaceholder} aria-hidden="true">
        ...
        <svg className={styles.scenePlaceholderIcon} viewBox="0 0 80 80" fill="none">
          <polygon
            points="40,8 72,28 72,52 40,72 8,52 8,28"
        ...
        <p className={styles.scenePlaceholderLabel} style={{ color: project.accent }}>
          3D scene — Phase 7.2+
        </p>
      </div>
      ...
      <div className={styles.content}>
        <div className={styles.tagRow}>
          {project.tags.map(t => (
            <span key={t} className={styles.tag} style={{ '--accent': project.accent }}>
              {t}
            </span>
          ))}
        </div>

        <h2 className={styles.title} style={{ color: project.accent }}>
          {project.title}
        </h2>
